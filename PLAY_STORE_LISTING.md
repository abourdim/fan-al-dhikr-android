# Play Store listing — Fan al-Dhikr (فن الذكر والدعاء)
...
- **Package name**: `org.workshopdiy.fanaldhikr`
...
```
كتاب "فن الذكر والدعاء" تطبيق تفاعلي — للشيخ محمد الغزالي
```

### Full description (≤4000 chars)
```
🤲 فن الذكر والدعاء — تطبيق تفاعلي

تطبيق تفاعلي ثلاثي اللغة (عربي/إنجليزي/فرنسي) مستوحى من كتاب "فن الذكر والدعاء" للشيخ محمد الغزالي رحمه الله (1917–1996).
...
• كتاب "فن الذكر والدعاء" — الشيخ محمد الغزالي
...
### App name
```
Fan al-Dhikr — The Art of Dhikr & Dua
```

### Short description
```
"The Art of Dhikr & Dua" — interactive trilingual app by Sheikh al-Ghazali
```
...
Interactive trilingual app (Arabic / English / French) based on the book "The Art of Dhikr & Dua" by Sheikh Mohammed al-Ghazali (1917–1996).
...
• "The Art of Dhikr & Dua" — Sheikh Mohammed al-Ghazali
...
### App name
```
Fan al-Dhikr — Fan al-Dhikr
```

### Short description
```
« The Art of Dhikr & Dua » — application trilingue par Cheikh al-Ghazali
```
...
Application interactive trilingue (arabe / anglais / français) inspirée du livre « The Art of Dhikr & Dua » du Cheikh Mohammed al-Ghazali (1917–1996).
...
• « The Art of Dhikr & Dua » — Cheikh Mohammed al-Ghazali
...
```
Privacy Policy — Fan al-Dhikr
Last updated: 2026-04-26

The Fan al-Dhikr app does not collect, store, transmit, or share any personal
